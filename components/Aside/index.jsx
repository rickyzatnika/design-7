  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen hidden lg:flex flex-col items-center justify-center">
        ...
        <div className="w-full min-h-screen fixed top-0 left-0  z-10 bg-gradient-to-t from-cyan-100/70 to-transparent mix-blend-overlay" />
        <div className="w-full min-h-screen fixed top-0 left-0  z-20 bg-gradient-to-t from-black to-transparent " />
        <Navbar />
